...
<section class="terms-section">
    <div class="terms-container">
        ...
        <div class="terms-title">
            ...
            <p class="terms-intro">En vigueur au 21/07/2025</p>
            <p class="terms-first">Les présentes conditions générales d'utilisation (dites « CGU ») ont pour objet l'encadrement juridique
            des modalités de mise à disposition du site et des services par Morning Soul et de définir les
            ...
            https://morningsoul.fr  se réserve le droit de modifier unilatéralement et à tout moment le contenu des 
            présentes CGU.</p>
        </div>

        <!-- Article 1 : Les mentions légales -->
        <div class="terms-first-article">
            <h3 id="mentions">Article 1 : Les mentions légales</h3>
            <p>L’édition et la direction de la publication du site https://morningsoul.fr est assurée par Peltier Vincent, 
            domicilié 29 Rue Boileau Crosne 91560.
            Numéro de téléphone est 06.51.12.42.45
            Adresse e-mail vincentpeltier.pro@outlook.fr.
            L'hébergeur du site https://morningsoul.fr est la société Vincent Peltier, dont le siège social est situé 
            au 29 Rue Boileau Crosne 91560, avec le numéro de téléphone : 06.51.12.45.</p>
        </div>

        <!-- Article 2 : Accès au site -->
        <div class="terms-second-article">
            <h3>Article 2 : Accès au site</h3>
            <p>Le site https://morningsoul.fr  permet à l'Utilisateur un accès gratuit aux services suivants :
            Le site internet propose les services suivants :
            Consultation de contenu, Participation communautaire, Création de compte, Profil utilisateur, 
            Notifications / Suivi, Modération / Signalement, Recherche et navigation, Interaction sociale
            ...
            pas la responsabilité de https://morningsoul.fr. Dans ces cas, l’Utilisateur accepte ainsi ne pas tenir 
        ...
        <div class="terms-third-article">
            ...
            exerce ce droit :
            · par mail à l'adresse email support@morningsoul.fr         
            · via un formulaire de contact;        
            · via son espace personnel;</p>   
        </div>

        <!-- Article 4 : Propriété intellectuelle -->
        <div class="terms-fourth-article">
            ...
            La marque Morning Soul est une marque déposée par Peltier Vincent.Toute représentation et/ou 
        ...
        <div class="terms-fifth-article">
            <h3>Article 5 : Responsabilité</h3>
            <p>Les sources des informations diffusées sur le site https://morningsoul.fr sont réputées fiables mais le 
            ...
            Malgré des mises à jour régulières, le site https://morningsoul.fr ne peut être tenu responsable de la 
            ...
            Le site https://morningsoul.fr ne peut être tenu pour responsable d’éventuels virus qui pourraient 
        ...
        <div class="terms-sixth-article">
            ...
            liens, il sortira du site https://morningsoul.fr. Ce dernier n’a pas de contrôle sur les pages web sur 
            lesquelles aboutissent ces liens et ne saurait, en aucun cas, être responsable de leur contenu.</p>
        </div>

        <!-- Article 7 : Cookies -->
        <div class="terms-seventh-article">
            <h3 id="cookies">Article 7 : Cookies</h3>
            ...
            l’Utilisateur par votre navigateur et qui sont nécessaires à l’utilisation du site https://morningsoul.fr. 
            ...
            L’information contenue dans les cookies est utilisée pour améliorer le site https://morningsoul.fr.
        ...
        <div class="terms-ninth-article">
            ...
            <br><br>CGU réalisées sur <a href="http://legalplace.fr/">http://legalplace.fr/</a></p>
        </div>
    </div>
</section>
