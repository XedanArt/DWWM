...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\AuthDebugController' => 'getAuthDebugControllerService',
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('qXVrk9-Yep', 0, ($container->targetDir.''.'/pools/app'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true));
    ...
    {
        return $container->services['cache.security_is_csrf_token_valid_attribute_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('wCXBqybdp4', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container))), ($container->privates['profiler.is_disabled_state_checker'] ?? self::getProfiler_IsDisabledStateCheckerService($container)));
    }
    ...
    {
        return $container->services['cache.security_is_granted_attribute_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('lJyscWp0hu', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container))), ($container->privates['profiler.is_disabled_state_checker'] ?? self::getProfiler_IsDisabledStateCheckerService($container)));
    }
    ...
    {
        return $container->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('es2FM+a9br', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container))), ($container->privates['profiler.is_disabled_state_checker'] ?? self::getProfiler_IsDisabledStateCheckerService($container)));
    }
    ...
    {
        return $container->services['cache.validator_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('z7yd-bTieI', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container))), ($container->privates['profiler.is_disabled_state_checker'] ?? self::getProfiler_IsDisabledStateCheckerService($container)));
    }
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $b->allowControllers(['App\\Kernel', 'App\\Controller\\AccountController', 'App\\Controller\\AuthController', 'App\\Controller\\AuthDebugController', 'App\\Controller\\DashboardController', 'App\\Controller\\ForumController', 'App\\Controller\\HomepageController', 'App\\Controller\\SecurityController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    {
        return $container->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('NG4GftF1TR', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container))), ($container->privates['profiler.is_disabled_state_checker'] ?? self::getProfiler_IsDisabledStateCheckerService($container)));
    }
    ...
    {
        return $container->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('uBs3b0gYVV', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container))), ($container->privates['profiler.is_disabled_state_checker'] ?? self::getProfiler_IsDisabledStateCheckerService($container)));
    }
    ...
    {
        return $container->privates['cache.security_token_verifier'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('2DdsYNn9Co', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container))), ($container->privates['profiler.is_disabled_state_checker'] ?? self::getProfiler_IsDisabledStateCheckerService($container)));
    }
    ...
    {
        return $container->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('1BWxEQmXIC', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container))), ($container->privates['profiler.is_disabled_state_checker'] ?? self::getProfiler_IsDisabledStateCheckerService($container)));
    }
    ...
    {
        return $container->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('6HhJ3o403-', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container))), ($container->privates['profiler.is_disabled_state_checker'] ?? self::getProfiler_IsDisabledStateCheckerService($container)));
    }
    ...
    protected static function getDoctrine_Orm_DefaultConfigurationService($container)
    {
        ...
        $instance->addCustomStringFunction('aes_decrypt', 'DoctrineExtensions\\Query\\Mysql\\AesDecrypt');
        $instance->addCustomStringFunction('aes_encrypt', 'DoctrineExtensions\\Query\\Mysql\\AesEncrypt');
        $instance->addCustomStringFunction('any_value', 'DoctrineExtensions\\Query\\Mysql\\AnyValue');
        $instance->addCustomStringFunction('ascii', 'DoctrineExtensions\\Query\\Mysql\\Ascii');
        $instance->addCustomStringFunction('binary', 'DoctrineExtensions\\Query\\Mysql\\Binary');
        $instance->addCustomStringFunction('cast', 'DoctrineExtensions\\Query\\Mysql\\Cast');
        $instance->addCustomStringFunction('char_length', 'DoctrineExtensions\\Query\\Mysql\\CharLength');
        $instance->addCustomStringFunction('collate', 'DoctrineExtensions\\Query\\Mysql\\Collate');
        $instance->addCustomStringFunction('concat_ws', 'DoctrineExtensions\\Query\\Mysql\\ConcatWs');
        $instance->addCustomStringFunction('countif', 'DoctrineExtensions\\Query\\Mysql\\CountIf');
        $instance->addCustomStringFunction('crc32', 'DoctrineExtensions\\Query\\Mysql\\Crc32');
        $instance->addCustomStringFunction('degrees', 'DoctrineExtensions\\Query\\Mysql\\Degrees');
        $instance->addCustomStringFunction('field', 'DoctrineExtensions\\Query\\Mysql\\Field');
        $instance->addCustomStringFunction('find_in_set', 'DoctrineExtensions\\Query\\Mysql\\FindInSet');
        $instance->addCustomStringFunction('format', 'DoctrineExtensions\\Query\\Mysql\\Format');
        $instance->addCustomStringFunction('from_base64', 'DoctrineExtensions\\Query\\Mysql\\FromBase64');
        $instance->addCustomStringFunction('greatest', 'DoctrineExtensions\\Query\\Mysql\\Greatest');
        $instance->addCustomStringFunction('group_concat', 'DoctrineExtensions\\Query\\Mysql\\GroupConcat');
        $instance->addCustomStringFunction('hex', 'DoctrineExtensions\\Query\\Mysql\\Hex');
        $instance->addCustomStringFunction('ifelse', 'DoctrineExtensions\\Query\\Mysql\\IfElse');
        $instance->addCustomStringFunction('ifnull', 'DoctrineExtensions\\Query\\Mysql\\IfNull');
        $instance->addCustomStringFunction('inet_aton', 'DoctrineExtensions\\Query\\Mysql\\InetAton');
        $instance->addCustomStringFunction('inet_ntoa', 'DoctrineExtensions\\Query\\Mysql\\InetNtoa');
        $instance->addCustomStringFunction('inet6_aton', 'DoctrineExtensions\\Query\\Mysql\\Inet6Aton');
        $instance->addCustomStringFunction('inet6_ntoa', 'DoctrineExtensions\\Query\\Mysql\\Inet6Ntoa');
        $instance->addCustomStringFunction('instr', 'DoctrineExtensions\\Query\\Mysql\\Instr');
        $instance->addCustomStringFunction('is_ipv4', 'DoctrineExtensions\\Query\\Mysql\\IsIpv4');
        $instance->addCustomStringFunction('is_ipv4_compat', 'DoctrineExtensions\\Query\\Mysql\\IsIpv4Compat');
        $instance->addCustomStringFunction('is_ipv4_mapped', 'DoctrineExtensions\\Query\\Mysql\\IsIpv4Mapped');
        $instance->addCustomStringFunction('is_ipv6', 'DoctrineExtensions\\Query\\Mysql\\IsIpv6');
        $instance->addCustomStringFunction('lag', 'DoctrineExtensions\\Query\\Mysql\\Lag');
        $instance->addCustomStringFunction('lead', 'DoctrineExtensions\\Query\\Mysql\\Lead');
        $instance->addCustomStringFunction('least', 'DoctrineExtensions\\Query\\Mysql\\Least');
        $instance->addCustomStringFunction('lpad', 'DoctrineExtensions\\Query\\Mysql\\Lpad');
        $instance->addCustomStringFunction('match', 'DoctrineExtensions\\Query\\Mysql\\MatchAgainst');
        $instance->addCustomStringFunction('md5', 'DoctrineExtensions\\Query\\Mysql\\Md5');
        $instance->addCustomStringFunction('nullif', 'DoctrineExtensions\\Query\\Mysql\\NullIf');
        $instance->addCustomStringFunction('over', 'DoctrineExtensions\\Query\\Mysql\\Over');
        $instance->addCustomStringFunction('radians', 'DoctrineExtensions\\Query\\Mysql\\Radians');
        ...
        $instance->addCustomStringFunction('rpad', 'DoctrineExtensions\\Query\\Mysql\\Rpad');
        $instance->addCustomStringFunction('sha1', 'DoctrineExtensions\\Query\\Mysql\\Sha1');
        $instance->addCustomStringFunction('sha2', 'DoctrineExtensions\\Query\\Mysql\\Sha2');
        $instance->addCustomStringFunction('soundex', 'DoctrineExtensions\\Query\\Mysql\\Soundex');
        $instance->addCustomStringFunction('str_to_date', 'DoctrineExtensions\\Query\\Mysql\\StrToDate');
        $instance->addCustomStringFunction('substring_index', 'DoctrineExtensions\\Query\\Mysql\\SubstringIndex');
        $instance->addCustomStringFunction('unhex', 'DoctrineExtensions\\Query\\Mysql\\Unhex');
        $instance->addCustomStringFunction('uuid_short', 'DoctrineExtensions\\Query\\Mysql\\UuidShort');
        $instance->addCustomNumericFunction('acos', 'DoctrineExtensions\\Query\\Mysql\\Acos');
        $instance->addCustomNumericFunction('asin', 'DoctrineExtensions\\Query\\Mysql\\Asin');
        $instance->addCustomNumericFunction('atan2', 'DoctrineExtensions\\Query\\Mysql\\Atan2');
        $instance->addCustomNumericFunction('atan', 'DoctrineExtensions\\Query\\Mysql\\Atan');
        $instance->addCustomNumericFunction('bit_count', 'DoctrineExtensions\\Query\\Mysql\\BitCount');
        $instance->addCustomNumericFunction('bit_xor', 'DoctrineExtensions\\Query\\Mysql\\BitXor');
        $instance->addCustomNumericFunction('ceil', 'DoctrineExtensions\\Query\\Mysql\\Ceil');
        $instance->addCustomNumericFunction('cos', 'DoctrineExtensions\\Query\\Mysql\\Cos');
        $instance->addCustomNumericFunction('cot', 'DoctrineExtensions\\Query\\Mysql\\Cot');
        $instance->addCustomNumericFunction('degrees', 'DoctrineExtensions\\Query\\Mysql\\Degrees');
        $instance->addCustomNumericFunction('exp', 'DoctrineExtensions\\Query\\Mysql\\Exp');
        $instance->addCustomNumericFunction('floor', 'DoctrineExtensions\\Query\\Mysql\\Floor');
        $instance->addCustomNumericFunction('json_contains', 'DoctrineExtensions\\Query\\Mysql\\JsonContains');
        $instance->addCustomNumericFunction('json_depth', 'DoctrineExtensions\\Query\\Mysql\\JsonDepth');
        $instance->addCustomNumericFunction('json_length', 'DoctrineExtensions\\Query\\Mysql\\JsonLength');
        $instance->addCustomNumericFunction('log', 'DoctrineExtensions\\Query\\Mysql\\Log');
        $instance->addCustomNumericFunction('log10', 'DoctrineExtensions\\Query\\Mysql\\Log10');
        $instance->addCustomNumericFunction('log2', 'DoctrineExtensions\\Query\\Mysql\\Log2');
        $instance->addCustomNumericFunction('pi', 'DoctrineExtensions\\Query\\Mysql\\Pi');
        $instance->addCustomNumericFunction('power', 'DoctrineExtensions\\Query\\Mysql\\Power');
        $instance->addCustomNumericFunction('quarter', 'DoctrineExtensions\\Query\\Mysql\\Quarter');
        $instance->addCustomNumericFunction('radians', 'DoctrineExtensions\\Query\\Mysql\\Radians');
        $instance->addCustomNumericFunction('rand', 'DoctrineExtensions\\Query\\Mysql\\Rand');
        $instance->addCustomNumericFunction('round', 'DoctrineExtensions\\Query\\Mysql\\Round');
        $instance->addCustomNumericFunction('stddev', 'DoctrineExtensions\\Query\\Mysql\\StdDev');
        $instance->addCustomNumericFunction('sin', 'DoctrineExtensions\\Query\\Mysql\\Sin');
        $instance->addCustomNumericFunction('std', 'DoctrineExtensions\\Query\\Mysql\\Std');
        $instance->addCustomNumericFunction('tan', 'DoctrineExtensions\\Query\\Mysql\\Tan');
        $instance->addCustomNumericFunction('variance', 'DoctrineExtensions\\Query\\Mysql\\Variance');
        $instance->addCustomDatetimeFunction('addtime', 'DoctrineExtensions\\Query\\Mysql\\AddTime');
        $instance->addCustomDatetimeFunction('convert_tz', 'DoctrineExtensions\\Query\\Mysql\\ConvertTz');
        $instance->addCustomDatetimeFunction('date', 'DoctrineExtensions\\Query\\Mysql\\Date');
        $instance->addCustomDatetimeFunction('date_format', 'DoctrineExtensions\\Query\\Mysql\\DateFormat');
        $instance->addCustomDatetimeFunction('dateadd', 'DoctrineExtensions\\Query\\Mysql\\DateAdd');
        $instance->addCustomDatetimeFunction('datesub', 'DoctrineExtensions\\Query\\Mysql\\DateSub');
        $instance->addCustomDatetimeFunction('datediff', 'DoctrineExtensions\\Query\\Mysql\\DateDiff');
        $instance->addCustomDatetimeFunction('day', 'DoctrineExtensions\\Query\\Mysql\\Day');
        $instance->addCustomDatetimeFunction('dayname', 'DoctrineExtensions\\Query\\Mysql\\DayName');
        $instance->addCustomDatetimeFunction('dayofweek', 'DoctrineExtensions\\Query\\Mysql\\DayOfWeek');
        $instance->addCustomDatetimeFunction('dayofyear', 'DoctrineExtensions\\Query\\Mysql\\DayOfYear');
        $instance->addCustomDatetimeFunction('div', 'DoctrineExtensions\\Query\\Mysql\\Div');
        $instance->addCustomDatetimeFunction('from_unixtime', 'DoctrineExtensions\\Query\\Mysql\\FromUnixtime');
        $instance->addCustomDatetimeFunction('hour', 'DoctrineExtensions\\Query\\Mysql\\Hour');
        $instance->addCustomDatetimeFunction('last_day', 'DoctrineExtensions\\Query\\Mysql\\LastDay');
        $instance->addCustomDatetimeFunction('makedate', 'DoctrineExtensions\\Query\\Mysql\\MakeDate');
        $instance->addCustomDatetimeFunction('minute', 'DoctrineExtensions\\Query\\Mysql\\Minute');
        $instance->addCustomDatetimeFunction('now', 'DoctrineExtensions\\Query\\Mysql\\Now');
        $instance->addCustomDatetimeFunction('month', 'DoctrineExtensions\\Query\\Mysql\\Month');
        $instance->addCustomDatetimeFunction('monthname', 'DoctrineExtensions\\Query\\Mysql\\MonthName');
        $instance->addCustomDatetimeFunction('period_diff', 'DoctrineExtensions\\Query\\Mysql\\PeriodDiff');
        $instance->addCustomDatetimeFunction('second', 'DoctrineExtensions\\Query\\Mysql\\Second');
        $instance->addCustomDatetimeFunction('sectotime', 'DoctrineExtensions\\Query\\Mysql\\SecToTime');
        $instance->addCustomDatetimeFunction('strtodate', 'DoctrineExtensions\\Query\\Mysql\\StrToDate');
        $instance->addCustomDatetimeFunction('time', 'DoctrineExtensions\\Query\\Mysql\\Time');
        $instance->addCustomDatetimeFunction('timediff', 'DoctrineExtensions\\Query\\Mysql\\TimeDiff');
        $instance->addCustomDatetimeFunction('timestampadd', 'DoctrineExtensions\\Query\\Mysql\\TimestampAdd');
        $instance->addCustomDatetimeFunction('timestampdiff', 'DoctrineExtensions\\Query\\Mysql\\TimestampDiff');
        $instance->addCustomDatetimeFunction('timetosec', 'DoctrineExtensions\\Query\\Mysql\\TimeToSec');
        $instance->addCustomDatetimeFunction('truncate', 'DoctrineExtensions\\Query\\Mysql\\Truncate');
        $instance->addCustomDatetimeFunction('week', 'DoctrineExtensions\\Query\\Mysql\\Week');
        $instance->addCustomDatetimeFunction('weekday', 'DoctrineExtensions\\Query\\Mysql\\WeekDay');
        $instance->addCustomDatetimeFunction('weekofyear', 'DoctrineExtensions\\Query\\Mysql\\WeekOfYear');
        $instance->addCustomDatetimeFunction('year', 'DoctrineExtensions\\Query\\Mysql\\Year');
        $instance->addCustomDatetimeFunction('yearmonth', 'DoctrineExtensions\\Query\\Mysql\\YearMonth');
        $instance->addCustomDatetimeFunction('yearweek', 'DoctrineExtensions\\Query\\Mysql\\YearWeek');
        $instance->addCustomDatetimeFunction('unix_timestamp', 'DoctrineExtensions\\Query\\Mysql\\UnixTimestamp');
        $instance->addCustomDatetimeFunction('utc_timestamp', 'DoctrineExtensions\\Query\\Mysql\\UtcTimestamp');
        $instance->addCustomDatetimeFunction('extract', 'DoctrineExtensions\\Query\\Mysql\\Extract');
